...
// stay installed and both fire, and the duplicate lines they write are collapsed by the reader on
// the host's own event id (dedupeEvents in lib/delta-cursor.mjs).
//
...
// session on the machine. See lib/hook-source.mjs.
